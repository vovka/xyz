...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/formreader

dist/Debug/GNU-Linux-x86/formreader: ${OBJECTFILES}
...
${OBJECTDIR}/params_parser.o: nbproject/Makefile-${CND_CONF}.mk params_parser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/params_parser.o params_parser.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/formreader
